...
function createButton(buttonTypeClass, buttonTeks, eventListener, btnRemove) {
  ...
  //dialogbox saat btn-remove ditekan
  if (btnRemove) {
...
function createCheckButton() {
  return createButton("mediumpurple", "Selesai dibaca", function (event) {
...
function createUndoButton() {
  return createButton("mediumpurple", "Belum selesai dibaca", function (event) {
